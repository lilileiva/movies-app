        ...
        <div className="flex flex-col container mx-auto">
            ...
            <div className='flex justify-center'>
                <div className='flex flex-col bg-gray-500 rounded-xl w-fit p-10 text-xl text-center mt-32'>
                    ...
                    <br />
                    <a target="_blank" href="http://github.com/lilileiva" className="bg-neutral-900 text-white border-2 rounded-xl mb-4">
                        GitHub
                    </a>
                    <a target="_blank" href="http://www.linkedin.com/in/lilianaleiva" className="bg-blue-700 text-white border-2 rounded-xl">
                        LinkedIn
                    </a>
                    <br />
